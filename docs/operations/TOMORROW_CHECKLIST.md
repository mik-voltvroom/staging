# Morgen: 30-60 minuten setup

- [ ] Google Workspace domein geverifieerd
- [ ] Zakelijk GitHub-account beschikbaar
- [ ] Volt & Vroom GitHub-organisatie aangemaakt
- [ ] Private repository aangemaakt
