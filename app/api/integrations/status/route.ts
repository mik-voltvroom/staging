...
export async function GET(request: Request) {
  ...
  const items: IntegrationStatus[] = [
    ...
    { key: "drive", label: "Google Drive", configured: driveConfigured(), mode: driveConfigured() ? "live" : "disabled", detail: "Shared Drive voertuigdossiers via keyless runtime identity" },
