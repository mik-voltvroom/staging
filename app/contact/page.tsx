  ...
  return <>
    ...
    <main className="contactPage"><div className="container">
      <div className="contactPageGrid">
        <div><p className="eyebrow">Volt & Vroom Groningen</p><h1>Kom langs of neem direct contact op.</h1><p className="lead">Wilt u een auto bekijken, uw situatie bespreken of gewoon weten welke aandrijflijn logisch is? Neem contact op. We houden het persoonlijk en duidelijk.</p><div className="contactDetails"><article><h2>Adres</h2><p>Euvelgunnerweg 50<br />9723 CW Groningen</p></article><article><h2>Contact</h2><p><a href="tel:+31502113883" data-vv-event="phone_click">050 211 3883</a><br /><a href="mailto:sales@voltvroom.nl" data-vv-event="email_click">sales@voltvroom.nl</a></p></article><article><h2>Bezoek plannen</h2><p>Plan uw route vooraf of neem contact op wanneer u speciaal voor een voertuig komt. Zo zorgen we dat er tijd is voor uitleg en een proefrit.</p></article></div></div>
