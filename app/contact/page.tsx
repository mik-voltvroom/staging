  ...
  return <>
    ...
    <main className="contactPage"><div className="container">
      <div className="contactPageGrid">
        <div><p className="eyebrow">Volt & Vroom Groningen</p><h1>Kom langs of neem direct contact op.</h1><p className="lead">Wilt u een auto bekijken, uw situatie bespreken of gewoon weten welke aandrijflijn logisch is? Neem contact op. We houden het persoonlijk en duidelijk.</p><div className="contactDetails"><article><h2>Adres</h2><p>Euvelgunnerweg 50<br />9723 CW Groningen</p></article><article><h2>Contact</h2><p><a href="tel:+31619163531" data-vv-event="phone_click">06 19 16 35 31</a><br /><a href="mailto:sales@voltvroom.nl" data-vv-event="email_click">sales@voltvroom.nl</a></p></article><article><h2>Bezoek plannen</h2><p>Plan uw route vooraf of neem contact op wanneer u speciaal voor een voertuig komt. Zo zorgen we dat er tijd is voor uitleg en een proefrit.</p></article></div></div>
      ...
      <section className="section"><div className="sectionHeading splitHeading"><div><p className="eyebrow">Persoonlijk advies</p><h2>Vertel wat u zoekt.</h2></div><p className="sectionIntro">Laat uw telefoonnummer of e-mailadres achter. Mik neemt persoonlijk contact met u op; u hoeft nog geen specifieke auto te hebben gekozen.</p></div><ContactForm vehicles={[]} /></section>
    </div></main>
    <SiteFooter />
  </>;
}
