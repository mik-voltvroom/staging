...
export default async function HomePage() {
  ...
  return <>
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "AutoDealer", "@id": "https://www.voltvroom.nl/#autodealer", name: "Volt & Vroom", legalName: "V&V B.V.", description: "Onafhankelijke specialist voor zorgvuldig geselecteerde hybride en elektrische occasions en Icons.", url: "https://www.voltvroom.nl", logo: "https://www.voltvroom.nl/brand/vv-logo-horizontal.svg", image: "https://www.voltvroom.nl/editorial/hero-v2.png", foundingDate: "2026", telephone: "+31502113883", email: "mik@voltvroom.nl", address: { "@type": "PostalAddress", streetAddress: "Euvelgunnerweg 50", postalCode: "9723 CW", addressLocality: "Groningen", addressCountry: "NL" }, areaServed: ["Groningen", "Drenthe", "Friesland"], knowsAbout: ["Hybride occasions", "Elektrische occasions", "Accugezondheid", "State of Health", "Praktijkverbruik", "Laadmogelijkheden", "CarCheck", "VVOS Voertuigrapport"], sameAs: ["https://www.youtube.com/@voltvroom"] }) }} />
