...
export default async function HomePage() {
  ...
  return <>
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "AutoDealer", "@id": "https://www.voltvroom.nl/#autodealer", name: "Volt & Vroom", legalName: "V&V B.V.", description: "Onafhankelijke specialist voor zorgvuldig geselecteerde hybride en elektrische occasions en Icons.", url: "https://www.voltvroom.nl", logo: "https://www.voltvroom.nl/brand/vv-logo-horizontal.svg", image: "https://www.voltvroom.nl/editorial/hero-v2.png", foundingDate: "2026", telephone: "+31502113883", email: "sales@voltvroom.nl", address: { "@type": "PostalAddress", streetAddress: "Euvelgunnerweg 50", postalCode: "9723 CW", addressLocality: "Groningen", addressCountry: "NL" }, areaServed: ["Groningen", "Drenthe", "Friesland"], knowsAbout: ["Hybride occasions", "Elektrische occasions", "Accugezondheid", "State of Health", "Praktijkverbruik", "Laadmogelijkheden", "CarCheck", "VVOS Voertuigrapport"], sameAs: ["https://www.youtube.com/@voltvroom"] }) }} />
    ...
    <main id="inhoud">
      ...
      <section id="advies" className="section contactSection"><div className="container contactLayout">
        <div className="contactCopy"><p className="eyebrow">Persoonlijk advies</p><h2>Vertel ons hoe u rijdt.</h2><p className="lead">Wij leggen uit wat bij uw gebruik past. U krijgt helder advies en persoonlijk contact.</p><div className="contactFacts"><a href="tel:+31502113883"><span>Bel direct</span><strong>050 211 3883</strong></a><a href="mailto:sales@voltvroom.nl"><span>Stuur een e-mail</span><strong>sales@voltvroom.nl</strong></a><a className="routePlannerLink" href="https://www.google.com/maps/dir/?api=1&destination=Euvelgunnerweg%2050%2C%209723%20CW%20Groningen&travelmode=driving" target="_blank" rel="noopener noreferrer" aria-label="Plan uw route naar Volt & Vroom via Google Maps"><span>Plan uw bezoek</span><strong>Euvelgunnerweg 50, Groningen ↗</strong></a></div></div>
