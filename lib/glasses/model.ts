...
export type InspectionSectionId = "identification" | "exterior" | "tires" | "interior" | "technical" | "hybrid_ev";
...
export interface InspectionSession {
  ...
  completedAt?: string;
  updatedAt: string;
  device: WearableDeviceSnapshot;
  currentSection: InspectionSectionId;
...
export interface Finding {
  ...
  estimatedRepairCostCents?: number;
  mediaIds: string[];
  confidence?: number;
...
export interface InspectionMedia {
  ...
  component?: string;
  location?: string;
  sourceDevice: WearableAdapterType;
  status: MediaStatus;
  sizeBytes?: number;
  createdBy: string;
  capturedAt: string;
...
export interface WearableDeviceAdapter {
  connect(): Promise<void>;
  disconnect(): Promise<void>;
  startCamera(): Promise<void>;
  stopCamera(): Promise<void>;
  capturePhoto(): Promise<MediaCapture>;
  startVideo(): Promise<void>;
  stopVideo(): Promise<MediaCapture>;
